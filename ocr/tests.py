...
from ocr.helpers import decode_image_from_url, process_image
...
class TestProcessImage:
    def test_normal(self) -> None:
        ...
        with patch(
            "ocr.helpers.decode_image_from_url", return_value=DEFAULT_OCRSPACE_RESPONSE
        ):
    ...
    def test_ocrexception(self) -> None:
        ...
        with patch("ocr.helpers.decode_image_from_url", return_value=ocrspace_response):
